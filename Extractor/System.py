...
class System(CobblerRecord):
    ...
    kw_map: KeywordMap = {
        ...
        'mgmt_classes':                 ('mgmt-classes', 'spaceList'),
        ...
        'ldap_enabled':                 ('ldap-enabled', 'skip'),
        'ldap_type':                    ('ldap-type', 'skip'),
        ...
        'power_type':                   ('power-type', 'skip'),
        'power_address':                ('power-address', 'skip'),
        'power_user':                   ('power-user', 'skip'),
        'power_pass':                   ('power-pass', 'skip'),
        'power_id':                     ('power-id', 'skip'),
    }
